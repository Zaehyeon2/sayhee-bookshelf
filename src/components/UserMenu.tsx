  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="cursor-pointer px-3 h-11 inline-flex items-center text-[14px] font-medium text-[var(--color-text-strong)] rounded-[var(--radius-toss-sm)] hover:bg-[var(--color-surface-2)] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-toss-blue)]/50"
      >
        {displayName} ▾
      </button>
      {open && (
