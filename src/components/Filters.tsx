  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="shrink-0 h-9 pl-3 pr-8 rounded-[var(--radius-field)] bg-[var(--color-surface-2)] text-[16px] text-[var(--color-text-strong)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] appearance-none"
      >
