...
export function SelectedChip({
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-[var(--radius-field)] bg-[var(--color-surface-2)] border border-[var(--color-border)]">
      {coverUrl ? (
      ...
      <button
        ...
        className="w-7 h-7 rounded-full text-[var(--color-text-muted)] hover:text-[var(--color-danger)] hover:bg-[var(--color-danger)]/10 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-danger)]"
      >
        ×
      </button>
    </div>
